...
import 'package:jnm_hospital_app/features/patient_module/patient_bills/data/patient_bills_usecases_impl.dart';
...
void initializeDependency(){
  ...
  getIt.registerFactory<PatientBillsUsecases>(()=> PatientBillsUsecasesImpl());
}