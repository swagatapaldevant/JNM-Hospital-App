              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    BarChartDetails(
                      type: ["OPD", "IPD", "Lab", "Pharmacy"], // types of billing or departments

                      total: [100, 150, 120, 80],             // Total amount for each type
                      grandTotal: [120, 170, 140, 100],       // Grand Total for each type
                      discount: [10, 20, 15, 5],              // Discount for each type
                      paid: [90, 140, 110, 75],               // Paid amount for each type
                      due: [20, 30, 25, 10],                  // Due amount for each type
                    ),
