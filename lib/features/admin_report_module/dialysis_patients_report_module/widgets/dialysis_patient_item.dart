...
// class DialysisPatientItem extends StatelessWidget {
//   final int? index;
...
class DialysisPatientItem extends StatefulWidget {
  final int? index;
  final String? patientName;
  final String? department;
  final String? uhid;
  ...
  @override
  State<DialysisPatientItem> createState() => _DialysisPatientItemState();
}

class _DialysisPatientItemState extends State<DialysisPatientItem>
                                ...
                                Row(
                                  children: [
                                    ...
                                    if (_has(widget.admissionType))
                                      _Chip(
                                        label: _val(widget.admissionType).toUpperCase(),
                                        color: _visitColor(widget.admissionType),
                                        bgColor: _visitColorBg(widget.admissionType),
                                      ),
                                  ],
                                ),
                                ...
                                child: Wrap(
                                  ...
                                  children: [
                                    ...
                                    if (_has(widget.appointmentTime))
                                      _TagChip(
                                        icon: Icons.alarm,
                                        label: widget.appointmentTime.toString(),
                                      ),
