...
class OpdPatientItemData extends StatefulWidget {
  final int? index;
  final String? patientName;
  final String? department;
  final String? uhid;
  ...
  @override
  State<OpdPatientItemData> createState() => _OpdPatientItemDataState();
}

class _OpdPatientItemDataState extends State<OpdPatientItemData>
