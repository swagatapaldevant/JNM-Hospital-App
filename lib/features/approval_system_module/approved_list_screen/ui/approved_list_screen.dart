...
//     "INVESTIGATION"
//   ];
//   final List<bool> _isLoading = List.generate(5, (_) => false); // NEW
//
//
...
//
//     setState(() => _isLoading[tabIndex] = true);               // NEW (start)
//
//     final resource = await ApprovedListUsecasesImpl()
...
//         _isLoading[tabIndex] = false;                          // NEW (done)
//       });
//     } else {
//       debugPrint("Error fetching approved list: ${resource.message}");
//       setState(() => _isLoading[tabIndex] = false);            // NEW (done even on error)
//     }
//   }
//
...
//                               // nice subtle gradient for the active pill
...
//                                 BoxShadow(
//                                   color:
//                                       const Color(0xFF6FD6FF).withOpacity(0.35),
//                                   blurRadius: 14,
