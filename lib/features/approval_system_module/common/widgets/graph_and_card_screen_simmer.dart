...
class GraphWithContainerSimmer extends StatelessWidget {
  const GraphWithContainerSimmer({super.key});
...
class GraphHeaderSimmer extends StatelessWidget {
  const GraphHeaderSimmer({super.key});

  @override
  Widget build(BuildContext contentGap1) {
    return Row(
      children: [
        Column(
          spacing: 2,
