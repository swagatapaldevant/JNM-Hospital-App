...
class PatientOPDUsecasesImpl implements PatientOPDUsecases {
  @override
  Future<Resource> getOPDDepartments() async {
    ...
    Resource resource = await _apiClient.getRequest(
      url: ApiEndPoint.getOPDDepartments,
      header: header,
    );
  ...
  @override
  Future<Resource> getOPDDoctors(int selectDeptId) async {
    final ApiClient _apiClient = getIt<ApiClient>();
    final SharedPref _pref = getIt<SharedPref>();
